...
export class CharGenOptions {
	...
	constructor() {
		...
		this.arcana = [
			...
			{ name: 'The Devil', virtue: { name: 'Astute', description: 'Activate your Virtue after a Villain spends Raises for an Action. That Action fails. Te Villain still loses the Raises she spent. '}, hubris: { name: 'Trusting', description: 'You receive a Hero Point when you accept someone’s lies or lopsided deal. '}},
			...
			{ name: 'The Emperor', virtue: { name: 'Commanding', description: 'Activate your Virtue. Te GM gives a Hero Point to all other Heroes in this Scene. '}, hubris: { name: 'Hot-Headed', description: 'You receive a Hero Point when your Hero flies off the handle and loses her temper, causing trouble.'}}
		];
